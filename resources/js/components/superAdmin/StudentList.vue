                                ...
                                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1" border="1">
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX" v-for="student in students" :key="student.id">
                                            ...
                                            <td>
                                                <a class="btn purple btn-outline dropdownCustom" data-toggle="modal" href="#login" @click="superLoginLoad(student.student_id, 4)">Log In</a>
                                            </td>
    ...
    export default {
        ...
        methods: {
            ...
            addStudent(){
                ...
                .then(res => res.json())
                .then(data => {
                    swal('Success!', "Student details added.", 'success');
                    this.clearForm();
                    this.viewStudents();
                })
                .catch(err => console.log(err))
