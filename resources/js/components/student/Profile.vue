                                        ...
                                        <div class="form-body">
                                            <div :class="{'form-group': true, 'form-group has-error': errors.has('name') }">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input name="name" v-model="user.name" v-validate="'required|alpha_spaces'" class="form-control"  type="text" placeholder="" disabled>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input name="student_id" v-model="user.student_id" class="form-control"  type="text" disabled>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input name="department" v-model="user.department" class="form-control"  type="text" disabled>
                                                </div>
                                            </div>
                                            <div :class="{'form-group': true, 'form-group has-error': errors.has('email') }">
                                                ...
                                                <div class="col-md-6">
                                                    <input name="email" v-model="user.email" v-validate="'required|email|uniqueEmail'" class="form-control"  type="email" disabled>
                                            ...
                                            <div :class="{'form-group': true, 'form-group has-error': errors.has('mobileNo') }">
                                                ...
                                                <div class="col-md-6">
                                                    <input name="mobileNo" v-model="user.mobileNo" v-validate="'required|numeric'" class="form-control"  type="text" disabled>
                                            ...
                                            <div class="form-group" align="right">
                                                ...
                                                <div class="col-md-6">
                                                    <!-- <button @click.prevent="updateUser(user.student_id)"  class="btn green">Save changes</button> -->
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="tab-pane" id="tab_1_2">
                                    <form class="form-horizontal" id="changePass">
                                        ...
                                        <div class="form-group col-md-10 ">
                                            ...
                                            <div class="input-icon col-md-offset-4 col-md-7" >
                                                <i class="fa fa-lock col-md-2"></i>
                                                <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="Old Password" name="oldPass" /> 
                                            </div>
                                        </div>
                                        <div class="form-group col-md-10">
                                            <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                                            ...
                                            <div class="input-icon col-md-offset-4 col-md-7">
                                                <i class="fa fa-lock col-md-2"></i>
                                                <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="New Password" id="newPass" name="newPass" /> 
                                            </div>
                                        </div>
                                        <div class="form-group col-md-10">
                                            <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                                            ...
                                            <div class="input-icon col-md-offset-4 col-md-7">
                                                <i class="fa fa-lock col-md-2"></i>
                                                <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="Retype new Password" name="newRePass" /> 
                                            </div>
                                        </div>
                                        <div class="form-group">
...
import axios from 'axios';
    ...
    export default {
        ...
        created(){
            ...
            this.viewUser(this.student_id );
        },
        methods:{
            viewUser(id){
                console.log(id);
                fetch(`api/student.profileDetails/${id}`)
                .then(res => res.json())
                .then(res => {
                    this.user.id = res.id;
                    this.user.name = res.name;
                    this.user.student_id = res.student_id;
                    this.user.department = res.department;
                    this.user.email = res.email;
                    this.user.mobileNo = res.mobileNo;
                    this.user.credits_left = res.credits_left;
