                                        ...
                                        <td>
                                            <div class="dropdown show">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink" style="min-width:100px;">
                                                        ...
                                                        <a  class="btn red btn-outline dropdownCustom" @click="deleteTeacher(teacher.teacher_id)">Delete</a>
                                                    </div>
                                                </div>
                                        </td>
                    ...
                    <div class="modal-body">  
                        ...
                        <form @submit.prevent="addTeacher()" id="form_sample_1" class="form-horizontal" > 
                            <div class="form-body">
                                ...
                                <div :class="{'form-group': true, 'form-group has-error': errors.has('TA_vacancy') }">
                                    <label class="control-label col-md-3">TA Vacancy.
                                        <span class="required"> * </span>
                                    </label>
                                    <div class="col-md-6">
                                        <input name="TA_vacancy" v-model="teacher.TA_vacancy" v-validate="'required|numeric'" class="form-control"  type="text" placeholder="">

                                        <i class="fa fa-exclamation-triangle required" v-show="errors.has('TA_vacancy')" ></i>
                                        <span v-show="errors.has('TA_vacancy')" class="required">{{ errors.first('TA_vacancy') }}</span>
                                    </div>
                                </div>
...
import axios from 'axios';
    ...
    export default {
        ...
        methods: {
            viewTeachers(){
                fetch('api/teachers.showTeacherList')
                .then(res => res.json())
                .then(res => {
            ...
            editTeacher(t){
                ...
                this.teacher.TA_vacancy = t.TA_vacancy;
            },
            clearForm(){
                this.add = true;
                this.edit  = false;
