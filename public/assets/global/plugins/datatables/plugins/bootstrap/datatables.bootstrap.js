...
$.extend(true, $.fn.dataTable.defaults, {
    "dom": "<'row'<'col-md-10 col-sm-10'f><'col-md-2 col-sm-2'l>r><'table-scrollable't><'row'<'col-md-5 col-sm-5'i><'col-md-7 col-sm-7'p>>", // default layout with horizobtal scrollable datatable
...
$.extend($.fn.dataTableExt.oStdClasses, {
    ...
    "sFilterInput": "form-control input-sm input-large input-inline",
